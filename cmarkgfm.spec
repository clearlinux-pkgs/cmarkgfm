...
Source0  : https://files.pythonhosted.org/packages/75/d0/1e4cd9be3482a892604dd82f256be00f6cbc572856ae7e3e0a5b1f6275bf/cmarkgfm-0.5.3.tar.gz
...
%prep
%setup -q -n cmarkgfm-0.5.3
cd %{_builddir}/cmarkgfm-0.5.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615560740
...
cp %{_builddir}/cmarkgfm-0.5.3/LICENSE.txt %{buildroot}/usr/share/package-licenses/cmarkgfm/592ea524450874d50778dd5db4a8dd176a0261e2
cp %{_builddir}/cmarkgfm-0.5.3/third_party/cmark/COPYING %{buildroot}/usr/share/package-licenses/cmarkgfm/fa524e3e5b56232fdada455ba84c938f5a1487d2
